...
> 说明：本文件主要记录 2026-04-09 时点的数据集构建与训练过程记忆，属于历史训练摘要，不应直接作为当前论文定稿实验口径。当前论文实验结论、物理空间指标、基线对比和 DDIM 诊断，应优先以 `.claude/project-context.md` 与 `docs/thesis/论文修订稿_第三轮结果版.md` 为准。
